...
ヘッダーの **🎼 SEQ** ボタンでピアノロールシーケンサーに切り替えられます。

- **▶ PLAY / ⏹ STOP** で再生・停止
- **BPM スライダー** でテンポ変更（40〜300）
- ピアノロール上でクリック / ドラッグでノートを描画・削除
- ✅️ Draw / 🗑️ Erase ツールで切り替え
- ツールバーの **◀ ▶ ボタン**、またはスワイプ / マウスホイールで横スクロール
- **11 曲のデモソング** を即座に読み込んで再生可能

| デモソング | スタイル |
|------------|--------|
| 🍿 Popcorn | バウンシーなシンセメロディ |
| 🎸 Acid Line | 303風アシッドベース |
| 🎹 Arpeggio | マイナーコードアルペジオ |
| 🌊 New Wave | ニューウェーブリフ |
| 🌙 Ambient | アンビエントシーケンス |
| 🎷 Funk Bass | ファンキーベースグルーブ |
| 🏃 Sequencer | クラシックシーケンサーパターン |
| 👻 Horror | ホラー / サスペンス |
| 🇮🇹 Italo Disco | イタロディスコベースライン |
| 🤖 Minimal | クラフトワーク風ミニマル |
| 🚀 Sci-Fi | SFアルペジオ |
